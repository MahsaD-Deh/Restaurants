...
using Restaurants.Application.Commands.Dish.Delete;
...
namespace Restaurants.API.Controllers
{
    ...
    public class DishesController(IMediator mediator) : ControllerBase
    {
        ...
        [HttpGet("{dishId}")]
        public async Task<ActionResult<IEnumerable<DishDto>>> GetDisheByIdForRestaurant([FromRoute] int restaurantId, [FromRoute]int dishId)
        {
